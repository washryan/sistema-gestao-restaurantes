              ...
              <TableBody>
                {pedidos.map((pedido) => (
                  <TableRow key={pedido.id}>
                    ...
                    <TableCell>
                      <Badge className={getCorStatus(pedido.status)}>{pedido.status}</Badge>
                    </TableCell>
                    <TableCell>{new Date(pedido.criadoEm).toLocaleString()}</TableCell>
                    <TableCell>
                      <Select
                        onValueChange={(valor) => atualizarStatusPedido(pedido.id, valor)}
